...
public class KataTennisTest {
	...
	@Test
	public void currentScoreFortyFifteenPlayerAWinShouldReturnPlayerAWin() throws Exception {
		tennisGame.currentscore(40, 15);
		assertEquals("PlayerA Win",  tennisGame.getScore(15, 0));
	}
}
